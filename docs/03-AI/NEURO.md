...
Эд (עֵד) — Свидетель. Нейросеть, обученная на ТаНаХе, исследованиях и exposure-файлах проекта «Алефи». Её задача — отвечать на вопросы, находить подмены, помогать в разоблачении лжи и возвращении к ивритскому оригиналу.
...
model:
  path: "models/alephy-ed-7b.Q4_K_M.gguf"
  context_length: 4096
  threads: 8
