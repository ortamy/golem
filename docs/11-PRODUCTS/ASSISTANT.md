...
**Метаданные файла**
- **Файл:** `docs/11-PRODUCTS/ASSISTANT.md`
- **Версия:** 1.0
...
- **Язык:** русский
- **Связанные файлы:** `ed/assistant/`, `docs/11-PRODUCTS/AGENT.md`, `docs/11-PRODUCTS/NEURO.md`, `guides/ASSISTANT.md`
- **Хеш:** ожидает
...
- `docs/11-PRODUCTS/AGENT.md` — агент «Эд»
- `docs/11-PRODUCTS/NEURO.md` — нейросеть «Эд»
- `docs/11-PRODUCTS/DAVAR.md` — язык Давар
- `guides/ASSISTANT.md` — руководство по запуску
