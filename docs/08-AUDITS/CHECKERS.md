> ⚠️ ИСТОРИЧЕСКИЙ ДОКУМЕНТ — описывает устаревшую структуру проекта. Актуальное состояние документации — `docs/08-AUDITS/DOCS-AUDIT-2026-09-02.md`.

```markdown
# 📜 GUIDE-CHECKERS — СПРАВОЧНИК ЧЕКЕРОВ

**Метаданные файла**
- **Файл:** `docs/08-AUDITS/CHECKERS.md`
- **Версия:** 2.0
...
- **Язык:** русский
- **Связанные файлы:** `tools/checkers/`, `guides/AUDIT.md`, `guides/CODING.md`
- **Хеш:** ожидает
