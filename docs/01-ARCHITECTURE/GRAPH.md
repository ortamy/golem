...
graph TD
  subgraph instructions
    instructions_chat_prompt_md["CHAT-PROMPT — ШАБЛОН ДЛЯ НОВОГО ЧАТА"]
    instructions_checkers_bdikah_checker_md["בְּדִיקָה — BDIKAH-CHECKER: ПРОВЕРКА ТЕКСТА НА РЕЛИГИОНИЗМЫ"]
    instructions_checkers_consistency_checker_md["✅ ЧЕКЕР СОГЛАСОВАННОСТИ (CONSISTENCY CHECKER)"]
    instructions_checkers_factcheck_md["בְּדִיקַת עֻבְדּוֹת — FACTCHECKER: ПРОВЕРКА ФАКТОВ"]
    instructions_checkers_mivdak_md["מִבְדָּק — MIVDAK: АУДИТ ПОЛЕЗНОСТИ ТЕКСТА"]
    instructions_checkers_startup_checklist_md["✅ ЧЕК-ЛИСТ ЗАГРУЗКИ ФАЙЛОВ ДЛЯ НАСТРОЙКИ НЕЙРОСЕТИ"]
    instructions_checkers_tikun_fix_md["תִּקּוּן — TIKUN-FIX: ШАБЛОН ЗАДАЧ ПО ОБНОВЛЕНИЮ"]
    instructions_coding_standards_md["СТАНДАРТЫ КОДА (CODING STANDARDS)"]
    instructions_collaboration_guide_md["🤝 РУКОВОДСТВО ДЛЯ КОНТРИБЬЮТОРОВ (COLLABORATION GUIDE)"]
    instructions_exposure_exposure_distortions_md["סוּגֵי עִיוּת — ТИПЫ ИСКАЖЕНИЙ И ИХ ПРИЁМЫ"]
    instructions_exposure_exposure_language_control_md["שְׁלִיטַת הַלָּשׁוֹן — ЯЗЫК КАК ИНСТРУМЕНТ КОНТРОЛЯ"]
    instructions_exposure_exposure_mechanisms_md["מַנְגְּנוֹנֵי חֲשִׂיפָה — МЕХАНИЗМЫ ПОДМЕНЫ"]
    instructions_exposure_exposure_methods_md["שִׁיטוֹת חֲשִׂיפָה — МЕТОДЫ РАЗОБЛАЧЕНИЯ"]
    instructions_exposure_exposure_principles_md["עֶקְרוֹנוֹת חֲשִׂיפָה — ОСНОВНЫЕ ПРИНЦИПЫ РАЗОБЛАЧЕНИЯ"]
    instructions_exposure_exposure_system_architecture_md["אַדְרִיכָלוּת הַמַּעֲרֶכֶת — АРХИТЕКТУРА СИСТЕМЫ"]
    instructions_exposure_exposure_techniques_md["תַּכְסִיסֵי חֲשִׂיפָה — ПРИЁМЫ ПОДМЕНЫ: ПОЛНЫЙ КАТАЛОГ"]
    instructions_exposure_exposure_theory_religionism_md["ТЕОРИЯ РЕЛИГИОНИЗМОВ — ПОЛНОЕ РАЗОБЛАЧЕНИЕ"]
    instructions_forbidden_words_md["מַפַּת מִלִּים אֲסוּרוֹת — КАРТА ЗАПРЕЩЁННЫХ СЛОВ"]
    instructions_image_map_md["תַּבְנִית מַפַּת דִּמּוּיִם — ШАБЛОН КАРТЫ ОБРАЗОВ"]
    instructions_images_catalogue_md["דִּמּוּיִם — ОБРАЗЫ ТАНАХА И БАШАХА"]
    instructions_manifest_md["מִנְשָׁר — МАНИФЕСТ ВОССТАНОВЛЕНИЯ"]
    instructions_methodology_archeology_methodology_md["אַרְכֵאוֹלוֹגְיָה שֶׁל מַשְׁמָעֻיּוֹת — АРХЕОЛОГИЯ СМЫСЛОВ"]
    instructions_methodology_hebrew_reconstruction_md["שִׁחְזוּר בְּשׂוֹרַת יֵשׁוּעַ — ВОССТАНОВЛЕНИЕ ИВРИТСКОГО ОР"]
    instructions_methodology_translation_methodology_md["ПЕРЕВОДЧЕСКАЯ МЕТОДОЛОГИЯ"]
    instructions_methodology_transliteration_distortions_md["תַּרְגּוּמֵי שֶׁקֶר — КЛЮЧЕВЫЕ ТРАНСЛИТЕРАЦИИ, ИСКАЖАЮЩИЕ СМ"]
    instructions_methodology_tree_method_md["שִׁיטַת הָעֵץ — МЕТОД ДЕРЕВА: КАК ПРОВЕРЯТЬ УЧЕНИЕ"]
    instructions_release_process_md["📦 ПРОЦЕСС ВЫПУСКА ВЕРСИЙ (RELEASE PROCESS)"]
    instructions_research_principles_md["עֶקְרוֹנוֹת — ПРИНЦИПЫ ИССЛЕДОВАНИЙ"]
    instructions_retrospective_md["רֶטְרוֹסְפֶּקְטִיבָה — РЕТРОСПЕКТИВА: ИТОГИ И УЛУЧШЕНИЯ"]
    instructions_security_policy_md["🔒 ПОЛИТИКА БЕЗОПАСНОСТИ (SECURITY POLICY)"]
  end
  subgraph researches
    researches_archive_allopaty_md["אָלוֹפַּתְיָה — АЛЛОПАТИЯ: ЛЕЧЕНИЕ СИМПТОМОВ ИЛИ Рефуа ЦЕЛОС"]
    researches_archive_caduceus_control_md["🐍 КАДУЦЕЙ: ЗМЕИ, ПОЗВОНОЧНИК И КОНТРОЛЬ"]
    researches_archive_g_generations_md["דּוֹרוֹת רֶשֶׁת — G-СВЯЗИ И КАТАСТРОФЫ: СОВПАДЕНИЕ ИЛИ АРХИТ"]
    researches_archive_gerewol_md["גֶּרֶווֹל — GEREWOL: Авода Бриа ВМЕСТО ТВОРЦА"]
    researches_archive_hygieia_md["גֵהְיָה — ЧАША ГИГИЕИ: От Рефуа ИЛИ КУЛЬТ НАРОДОВ?"]
    researches_archive_microplastics_md["מִיקְרוֹפְּלַסְטִיק — МИКРОПЛАСТИК: НЕВИДИМОЕ ЗАГРЯЗНЕНИЕ"]
    researches_archive_new_year_md["רֹאשׁ הַשָּׁנָה הַשִּׁקְרִי — НОВЫЙ ГОД: РИМСКИЙ КУЛЬТ ЯНУСА"]
    researches_archive_paracelsus_md["פָּרַצֵלְסוּס — ПАРАЦЕЛЬС: АЛХИМИК, ПЕРЕВОРОТЧИК, ЦЕЛИТЕЛЬ"]
    researches_archive_pedophilia_md["תּוֹעֵבָה — ПЕДОФИЛИЯ: МЕДИЦИНСКИЙ Мунах ИЛИ ТОЭВА?"]
    researches_archive_pornography_md["זָנָה — ПОРНОГРАФИЯ: ПРОДАЖА ОТДЕЛЁННОСТИ ЗА Таава"]
    researches_archive_psychology_md["פְּסִיכוֹלוֹגְיָה — ПСИХОЛОГИЯ: ПСЮХЕ ПРОТИВ НЭФЕШ"]
    researches_archive_pyramid_bunker_md["פִּירָמִידָה — ПИРАМИДА: ГРОБНИЦА ИЛИ БУНКЕР?"]
    researches_archive_rock_mantras_md["rock-mantras"]
    researches_archive_slavs_md["סְלָבִים — СЛАВЯНЕ: ЛЮДИ СЛОВА"]
    researches_books_analiz_poryadka_genri_md["סֵדֶר עוֹלָמִי — МИРОВОЙ ПОРЯДОК: КИССИНДЖЕР И Мемшала ХАОСО"]
    researches_books_machiavelli_the_prince_md["הַנָּסִיךְ — ГОСУДАРЬ: МАКИАВЕЛЛИ И ВЛАСТЬ БЕЗ ЯХВЕ"]
    researches_companies_amazon_md["אָמָזוֹן — AMAZON: ТОРГОВЛЯ БЕЗ ЛИЦА"]
    researches_companies_blackrock_md["בְּלַקְרוֹק — BLACKROCK: ЧЁРНАЯ СКАЛА МИРОВОЙ ВЛАСТИ"]
    researches_companies_goldman_sachs_md["גּוֹלְדְמַן זַקְס — GOLDMAN SACHS: ДЕНЬГИ КАК ВЛАСТЬ"]
    researches_companies_google_md["גּוּגֶל — GOOGLE: ОРАКУЛ СИСТЕМЫ"]
    researches_companies_ibm_md["י.ב.מ. — IBM: МАШИНА УЧЁТА И КОНТРОЛЯ"]
    researches_companies_jpmorgan_md["גֵ'יי.פִּי.מוֹרְגָן — JPMORGAN CHASE: ИМПЕРИЯ КРЕДИТА И КОНТ"]
    researches_companies_meta_md["מֶטָא — META: ЦИФРОВОЙ ВАВИЛОН"]
    researches_companies_neuralink_md["נֵיירָלִינְק — NEURALINK: ЧИП В МОЗГ КАК ПЕЧАТЬ ЗВЕРЯ"]
    researches_companies_palantir_md["פַּלַנְטִיר — PALANTIR: ВИДЯЩИЙ КАМЕНЬ СИСТЕМЫ"]
    researches_companies_vanguard_md["וַנְגַּארְד — VANGUARD: НЕВИДИМАЯ РУКА РЫНКА"]
    researches_economy_banks_and_financial_dynasties_md["БАНКИ И ФИНАНСОВЫЕ ДИНАСТИИ — АРХИТЕКТУРА ГЛОБАЛЬНОГО КОНТРО"]
    researches_economy_gambling_vs_life_md["קוּבְּיָה אוֹ חַיִּים — ИГРАТЬ ИЛИ ЖИТЬ?"]
    researches_economy_money_symbols_md["💱 РУБЛЬ, ЕВРО, ДОЛЛАР: ЯЗЫЧЕСКИЕ ЗНАКИ НА ДЕНЬГАХ"]
    researches_economy_mortgage_dead_pledge_md["ИПОТЕКА — МЕРТВЫЙ ЗАЛОГ НА ЖИЗНЬ"]
  end
  subgraph terminology
    terminology_ahava_md["АГАПЭ (AHАVA) — Аhава"]
    terminology_arum_md["עָרוּם — АРУМ: ХИТРЫЙ, ПРОНИЦАТЕЛЬНЫЙ"]
    terminology_arur_md["אָרוּר — АРУР: Арур КАК ОГРАНИЧЕНИЕ, А НЕ МЕСТЬ"]
    terminology_asur_md["אָסוּר — АСУР: СВЯЗАННЫЙ, ОГРАНИЧЕННЫЙ, В ОКОВАХ"]
    terminology_avar_atid_md["עָבַר וְעָתִיד — АВАР И АТИД: СБЫВШЕЕСЯ И НЕСБЫВШЕЕСЯ"]
    terminology_avodah_zarah_md["עֲבוֹדָה זָרָה — АВОДА ЗАРА: ЧУЖАЯ СЛУЖБА"]
    terminology_avon_md["עָוֹן (АВОН) — ИСКРИВЛЕНИЕ, А НЕ «БЕЗЗАКОНИЕ»"]
    terminology_barach_md["בָּרַח (БАРАХ) — БЕГСТВО К YHWH, А НЕ «ПОБЕГ ОТ МИРА»"]
    terminology_bavel_md["בָּבֶל — БАВЭЛЬ: Ирбув, КОТОРОЕ НАЗЫВАЕТ СЕБЯ ПОРЯДКОМ"]
    terminology_bayit_md["בַּיִת (БАЙТ) — ДОМ, А НЕ «ХРАМ»"]
    terminology_beit_ha_mikdash_md["בֵּית הַמִּקְדָּשׁ — БЕЙТ hА-МИКДАШ: ДОМ ОТДЕЛЁННОСТИ"]
    terminology_brit_md["בְּרִית (БРИТ) — Брит, А НЕ «ЗАВЕТ»"]
    terminology_chamas_md["חָמָס (ХАМАС) — НАСИЛИЕ, А НЕ ПРОСТО «ГРЕХ»"]
    terminology_cherut_md["חֵרוּת — ХЕРУТ: Хофеш ДЛЯ ВЕРНОСТИ"]
    terminology_chesed_md["חֶסֶד (ХЕСЕД) — ПРЕДАННАЯ Аhава, А НЕ «МИЛОСТЬ» И НЕ «БЛАГОД"]
    terminology_derech_apayim_md["אֶרֶךְ אַפַּיִם — ЭРЕХ АПАЙИМ: ДОЛГОЕ ДЫХАНИЕ ВМЕСТО ТЕРПЕНИ"]
    terminology_derech_md["דֶּרֶךְ (ДЕРЕХ) — Дэрех, А НЕ «РЕЛИГИЯ»"]
    terminology_el_md["אֵל — НЕ «БОГ», А Коах, МОЩЬ, ИСТОЧНИК"]
    terminology_elil_md["אֱלִיל (ЭЛИЛЬ) — НИЧТОЖЕСТВО, А НЕ «ИДОЛ» КАК СТАТУЯ"]
    terminology_elilim_md["אֱלִילִים — ЭЛИЛИМ: НИЧТОЖНЫЕ, БЕССИЛЬНЫЕ"]
    terminology_emet_md["אֱמֶת (ЭМЕТ) — НАДЁЖНОСТЬ, А НЕ «ИСТИНА» КАК АБСТРАКЦИЯ"]
    terminology_emuna_md["אֱמוּנָה (ЭМУНА) — ВЕРНОСТЬ, А НЕ «ВЕРА»"]
    terminology_erech_apayim_md["ЭРЕХ АПАЙИМ (ERECH APAYIM) — ДОЛГОЕ ДЫХАНИЕ"]
    terminology_etz_ha_daat_md["עֵץ הַדַּעַת — ЭЦ hА-ДААТ: ДЕРЕВО ПОЗНАНИЯ"]
    terminology_eved_md["עֶבֶד (ЭВЕД) — Эвед, А НЕ «РАБ» В УНИЗИТЕЛЬНОМ Машмаут"]
    terminology_gerim_md["גֵּרִים (ГЕРИМ) — ПРИШЕЛЬЦЫ, А НЕ «ПРОЗЕЛИТЫ» И НЕ «ИНОВЕРЦЫ"]
    terminology_gibor_md["גִּבּוֹר — ГИБОР: СИЛЬНЫЙ, ВОИН, МОГУЧИЙ"]
    terminology_golem_md["גֹּלֶם — ГОЛЕМ: НЕОФОРМЛЕННАЯ МАТЕРИЯ В РУКАХ ЯХВЕ"]
    terminology_goyim_md["גּוֹי (ГОЙ) — НАРОД, А НЕ «ЯЗЫЧНИК»"]
    terminology_hacker_md["ХАКЕР — НЕ КОМПЬЮТЕРНЫЙ ВЗЛОМЩИК, А РЕЖУЩИЙ Эмет"]
  end
```
...
`docs/06-METHODOLOGY/ARCHEOLOGY-METHODOLOGY.md`

### שִׁחְזוּר בְּשׂוֹרַת יֵשׁוּעַ — ВОССТАНОВЛЕНИЕ ИВРИТСКОГО ОР
`docs/06-METHODOLOGY/HEBREW-RECONSTRUCTION.md`

### ПЕРЕВОДЧЕСКАЯ МЕТОДОЛОГИЯ
`docs/06-METHODOLOGY/TRANSLATION-METHODOLOGY.md`

### תַּרְגּוּמֵי שֶׁקֶר — КЛЮЧЕВЫЕ ТРАНСЛИТЕРАЦИИ, ИСКАЖАЮЩИЕ СМ
`docs/06-METHODOLOGY/TRANSLITERATION-DISTORTIONS.md`

### שִׁיטַת הָעֵץ — МЕТОД ДЕРЕВА: КАК ПРОВЕРЯТЬ УЧЕНИЕ
`docs/06-METHODOLOGY/TREE-METHOD.md`
...
`docs/12-TEMPLATES/CONCEPT-ANALYSIS-TEMPLATE.md`

### ШАБЛОН ИССЛЕДОВАНИЯ
`docs/12-TEMPLATES/RESEARCH-TEMPLATE.md`

### ШАБЛОН САМООБУЧЕНИЯ НЕЙРОСЕТИ
`docs/12-TEMPLATES/SELF-LEARNING-TEMPLATE.md`
