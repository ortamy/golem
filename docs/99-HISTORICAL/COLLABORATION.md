...
**Метаданные файла**
- **Файл:** `docs/99-HISTORICAL/COLLABORATION.md`
- **Версия:** 1.1
- **Дата создания:** 2026-06-05
- **Последнее обновление:** 2026-06-11
- **Причина обновления:** Обновлены цифры, имена файлов, добавлен Cline
- **Статус:** Исторический
- **Тема:** Как участвовать в проекте «Алефи» — правила, процесс, коммуникация
...
Проект «Алефи» открыт для всех, кто хочет участвовать в восстановлении истины ТаНаХа.
