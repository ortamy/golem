...
**Метаданные файла**
- **Файл:** `docs/99-HISTORICAL/SETUP.md`
- **Версия:** 1.0
- **Дата создания:** 2026-06-09
- **Последнее обновление:** 2026-06-09
- **Причина обновления:** Первичное создание
- **Статус:** Исторический
- **Тема:** Полная настройка рабочего окружения для проекта «Алефи»

---

## 🔥 ВВЕДЕНИЕ

Для полноценной работы с проектом «Алефи» нужно установить несколько программ и расширений. Этот гайд проведёт через всё — от Git до нейросети.
...
```
windows-curses>=2.4.0    # меню alephy.py (Windows)
...
- Открыть папку `alephy/` как Vault
