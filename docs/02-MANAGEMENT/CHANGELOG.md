...
- Создан `system-architecture.md` — архитектура системы: 9 компонентов, 4 этапа вербовки, 5 стадий жизни
- Создан `exposure-language-control.md` — язык как инструмент контроля
- Расширен `religionism-theory.md` — добавлены медицина, наука, военное дело, 7 этапов подмены
- Создан `techniques.md` — полный каталог 60+ приёмов подмены
- Обновлён `methods.md` — добавлены методы 24-29 (этимологическое разоблачение, юридическая археология, архитектурное разоблачение, исторический слой, проверка символа, финансовое разоблачение)
- Обновлён `mechanisms.md` — добавлены 2 новых механизма (подмена живого на структуру, подмена прощения на накопление)
...
**Обновления скриптов:**
- `alephy.py` v4.1 — авто-сканирование скриптов в подпапках, меню обновляется автоматически при добавлении новых скриптов
...
- `alephy.py` обновлён до v3.5 — древовидное меню, анимация запуска, все пути исправлены
...
- `alephy.py` — убраны несуществующие скрипты, добавлены реальные пути
