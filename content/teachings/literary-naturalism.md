# 🌳 Натурализм (литературный) — ПРОВЕРКА МЕТОДОМ ДЕРЕВА
...
- **Статус:** Черновик
- **Тема:** Проверка учения «Натурализм (литературный)» методом дерева — от семени до плодов
...
- **Учение:** Натурализм (литературный)
- **Основатель:** [имя, дата.]
