...
**Правило:** каждая техника — с источником и способом применения в токенах ALEPHY. Скриншоты чужих сайтов не собирались: вместо них — техника + ссылка; скриншоты делаем только для ALEPHY (before/after, этап C).
...
- **hypercolor.dev** (таймаут): градиентные пресеты; ниже — адаптации в палитре ALEPHY.
- **21st.dev** (таймаут): hero-паттерны — kicker → заголовок → подзаголовок, stagger-появление, крупный whitespace.

---

## Техники (20) и применение в ALEPHY
