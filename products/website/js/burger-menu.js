document.addEventListener('DOMContentLoaded', function() {
    ...
    var menuTexts = {
        ru: { home: 'Главная', research: 'Исследования', methods: 'Методы разоблачения', dictionaries: 'Словари', methodology: 'Методология', about: 'О проекте', logo: 'ГОЛЕМ' },
        en: { home: 'Home', research: 'Research', methods: 'Exposure Methods', dictionaries: 'Dictionaries', methodology: 'Methodology', about: 'About', logo: 'GOLEM' },
        he: { home: 'ראשי', research: 'מחקר', methods: 'שיטות חשיפה', dictionaries: 'מילונים', methodology: 'מתודולוגיה', about: 'אודות', logo: 'גולם' }
    };
