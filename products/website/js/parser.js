...
(function(global) {
    ...
    function parseMD(t, fileIcon) {
        ...
        html = html.replace(/!\[icon\]\(([^)]+)\)/g, function(_, src) {
            return '<img src="' + escHtml(src) + '" class="h2-icon" alt="Иконка раздела" style="width:20px;height:20px;vertical-align:middle;margin-right:8px;">';
        });
