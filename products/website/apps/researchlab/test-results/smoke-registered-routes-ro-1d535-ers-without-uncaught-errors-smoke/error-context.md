...
- Name: smoke.spec.js >> registered routes >> route #method-archeology renders without uncaught errors
      ...
      - generic [ref=e15]:
        ...
        - generic [ref=e57]:
          ...
          - link "Настройки" [ref=e61] [cursor=pointer]:
            - /url: "#admin-settings"
    - main [ref=e62]:
      - generic [ref=e63]: "Ошибка загрузки: HTTP 404 for ../../../analysis/methodology/methodology-archeology.md"
  - contentinfo [ref=e65]:
    - link "Проект «Голем»" [ref=e66] [cursor=pointer]:
      - /url: ../pages/index.html
    - text: — восстановление истины. |
    - link "GitHub" [ref=e67] [cursor=pointer]:
      - /url: https://github.com/ortamy/golem
    - text: "| v0.2.0"
  - generic "Горячие клавиши" [ref=e68] [cursor=pointer]: ⌨ ?
```
