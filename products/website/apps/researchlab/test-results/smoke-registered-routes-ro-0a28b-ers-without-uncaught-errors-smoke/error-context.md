...
- Name: smoke.spec.js >> registered routes >> route #cartography renders without uncaught errors
- Location: tests\smoke.spec.js:55:5

# Error details

```
Error: uncaught errors on #cartography
...
- Array []
+ Array [
+   "console: [Cartography] Ошибка загрузки: Error: HTTP 404 for world map
+     at http://127.0.0.1:4173/js/cartography.js:177:31
