...
- Name: smoke.spec.js >> registered routes >> route #translation-comparator renders without uncaught errors
          ...
          - generic [ref=e64]:
            - paragraph [ref=e65]:
              - link "ГОЛЕМ" [ref=e66] [cursor=pointer]:
                - /url: "#dashboard"
              - text: ·
              - link "Компаратор" [ref=e67] [cursor=pointer]:
                - /url: "#translation-comparator"
            - heading "Компаратор" [level=1] [ref=e68]
            - paragraph [ref=e71]: Сопоставление переводов для обнаружения сдвигов, потерь и смысловых подмен.
        - generic [ref=e72]:
          - generic [ref=e73]: Ссылка на стих
          - generic [ref=e74]:
            - textbox "Ссылка на стих" [ref=e75]:
              - /placeholder: Берешит 1:1, Исайя 53:5
            - button "Показать" [ref=e76] [cursor=pointer]
        - generic [ref=e77]:
          - text: "Введите ссылку на стих. Пример:"
          - strong [ref=e78]: Берешит 1:1
          - text: .
  - contentinfo [ref=e79]:
    - link "Проект «Голем»" [ref=e80] [cursor=pointer]:
      - /url: ../pages/index.html
    - text: — восстановление истины. |
    - link "GitHub" [ref=e81] [cursor=pointer]:
      - /url: https://github.com/ortamy/golem
    - text: "| v0.2.0"
  - generic "Горячие клавиши" [ref=e82] [cursor=pointer]: ⌨ ?
```
