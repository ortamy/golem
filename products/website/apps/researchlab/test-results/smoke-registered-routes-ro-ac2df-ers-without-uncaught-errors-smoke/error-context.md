...
- Name: smoke.spec.js >> registered routes >> route #layer-analyzer renders without uncaught errors
          ...
          - generic [ref=e64]:
            - paragraph [ref=e65]:
              - link "ГОЛЕМ" [ref=e66] [cursor=pointer]:
                - /url: "#dashboard"
              - text: ·
              - link "Layer Analyzer" [ref=e67] [cursor=pointer]:
                - /url: "#layer-analyzer"
            - heading "layer analyzer" [level=1] [ref=e68]
        - generic [ref=e70]:
          - generic [ref=e72]:
            - heading "Слой-анализ" [level=1] [ref=e73]
            - paragraph [ref=e74]: Измерьте присутствие восьми слоёв и найдите доминирующий сдвиг.
          - generic [ref=e75]:
            - generic [ref=e76]:
              - heading "Входной Давар" [level=2] [ref=e77]
              - generic [ref=e78]: Текст для анализа
              - textbox "Текст для анализа" [ref=e79]:
                - /placeholder: Вставьте текст для вертикального прохода…
              - generic [ref=e80]:
                - button "Запустить анализ" [ref=e81] [cursor=pointer]
                - button "Очистить" [ref=e82] [cursor=pointer]
              - paragraph [ref=e83]: Результат — диагностический сигнал, а не автоматический приговор. Сверяйте его с методологией MANIFEST.
              - status [ref=e84]
            - generic [ref=e85]:
              - heading "Результат прохода" [level=2] [ref=e86]
              - generic [ref=e87]: Заполните поле и запустите анализ.
  - contentinfo [ref=e89]:
    - link "Проект «Голем»" [ref=e90] [cursor=pointer]:
      - /url: ../pages/index.html
    - text: — восстановление истины. |
    - link "GitHub" [ref=e91] [cursor=pointer]:
      - /url: https://github.com/ortamy/golem
    - text: "| v0.2.0"
  - generic "Горячие клавиши" [ref=e92] [cursor=pointer]: ⌨ ?
```
