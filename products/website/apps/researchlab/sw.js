const CACHE_NAME = 'golem-cache-v16';
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => Promise.all([
        ...
        cache.addAll(['data/methodology/cards.json', 'data/methodology/methods.json', 'data/methodology/mechanisms.json', 'data/methodology/cultural-matrices.json'])
      ]))
