// Research Board Generator - Main JavaScript
...
function addEvidence() {
  ...
  div.dataset.id = id;
  div.style.cssText = 'margin-bottom: 12px; padding: 12px; background: #faf3e0; border: 1px solid #d4c4a8; border-radius: 4px;';
  
  div.innerHTML = `
    <div style="display: flex; gap: 8px; margin-bottom: 8px;">
      <input type="text" placeholder="Название улики #${index}" 
        style="flex: 1; padding: 8px 10px; font-family: 'EB Garamond', Georgia, serif; font-size: 14px; border: 1px solid #d4c4a8; border-radius: 4px; background: #faf3e0; color: #2c1810; outline: none;"
        onfocus="this.style.borderColor='#b8860b'" onblur="this.style.borderColor='#d4c4a8'">
      <button type="button" onclick="removeEvidence(${id})" 
        style="padding: 8px 12px; background: #c0392b; color: #faf3e0; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: 600;">
        ✕
      </button>
    </div>
    <textarea placeholder="Описание улики..." rows="2"
      style="width: 100%; padding: 8px 10px; font-family: 'EB Garamond', Georgia, serif; font-size: 14px; border: 1px solid #d4c4a8; border-radius: 4px; background: #faf3e0; color: #2c1810; outline: none; resize: vertical;"
      onfocus="this.style.borderColor='#b8860b'" onblur="this.style.borderColor='#d4c4a8'"></textarea>
  `;
...
function addAttachment() {
  ...
  div.innerHTML = `
    ...
    <input type="text" placeholder="Ссылка на изображение/документ (URL)" 
      style="width: 100%; padding: 8px 10px; font-family: 'EB Garamond', Georgia, serif; font-size: 14px; border: 1px solid #d4c4a8; border-radius: 4px; background: #faf3e0; color: #2c1810; outline: none; margin-bottom: 8px;"
      onfocus="this.style.borderColor='#b8860b'" onblur="this.style.borderColor='#d4c4a8'">
...
// The burger menu is already loaded from burger-menu.js
// This function is called by the hamburger button
function toggleSidePanel() {
  if (typeof toggleSidePanel === 'function') {
    // Function is already defined in burger-menu.js
    toggleSidePanel();
  }
}